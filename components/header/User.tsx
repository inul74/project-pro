...
export const User = ({ profileImage, username, email }: Props) => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        asChild
        className="rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background ml-2"
      >
      ...
      <DropdownMenuContent align="end" sideOffset={10} className="">
        ...
        <DropdownMenuGroup>
          <DropdownMenuSub>
            <DropdownMenuSubTrigger asChild className="cursor-pointer gap-2">
