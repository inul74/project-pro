      ...
      <div className="w-full mx-auto max-w-screen-xl px-4 sm:px-6">
        ...
        <main>
          <TextSection
            ...
            desc="Maximize your team’s efficiency with ProjectPro—an all-in-one workspace designed to consolidate your essential tools into one cohesive platform."
          />
          ...
          <Section
            ...
            desc="Project Pro role management system simplifies workspace oversight. Admins and owners can adjust user roles, manage account and workspace settings, and oversee permissions to ensure smooth collaboration."
          ...
          <TextSection
            ...
            desc=" Effortlessly share projects and invite others to join with easy shareable links. ProjectPro enables instant project review and real-time chatting with team members from anywhere."
          />
